...
import com.example.jetpackcomposepractice.composebles.modifierPractice.BorderedTextPractice
        ...
        setContent {
            JetpackComposePracticeTheme {
                Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
                    BorderedTextPractice(modifier = Modifier.padding(innerPadding))
                }
            }
        }
    }
